...
public class TcpChatClientB {
    
    private static final long FROM_URI = 981101;
    private static final long FROM_OS_TYPE = 1;
    private static final long TO_URI = 723181;
    ...
    public TcpChatClientB(String host, int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public static void main(String[] args) throws Exception {  
        new TcpChatClientB("127.0.0.1", 9099).start();
    }
}
